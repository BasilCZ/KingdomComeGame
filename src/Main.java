...
public class Main {
    public static void main(String[] args) {
        if(LoadGame.load()){
            Player p = new Player(200, 300, 10, 10, 100, new Armor(4, "fdg", "gddsg", 1, 1, true, ArmorType.HELMET, 10), new Armor(5, "fg", "ff", 1, 1, true, ArmorType.CHESTPLATE, 10), new Armor(6, "fsaga", "gkdg", 1, 1, true, ArmorType.LEGGINGS, 1), new Weapon(2, "gdsggdsh", "gsdgdgd", 1, 1, true, WeaponType.LONG_SWORD, 30, 20), 10000, 10, 10, 10);
